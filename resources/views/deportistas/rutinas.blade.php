...
<div class="container">
    ...
    <div style="margin-bottom: 20px; overflow-x: auto; white-space: nowrap;">
        <a href="{{ route ('deportistas.rutinas', 'abdominales')}}" style="display: inline-block; background-color: #0d6efd; color: white; padding: 8px 20px; border-radius: 50px; margin-right: 10px; text-decoration: none; font-weight: 500;">Abdominales</a>
        <a href="{{ route ('deportistas.rutinas', 'brazo')}}" style="display: inline-block; background-color: #f5f5f5; color: #333; padding: 8px 20px; border-radius: 50px; margin-right: 10px; text-decoration: none; font-weight: 500;">Brazo</a>
    ...
    <div>
        ...
        <div style="display: flex; padding: 15px 0; border-bottom: 1px solid #eee;">
            <div style="width: 120px; height: 120px; border-radius: 10px; overflow: hidden; flex-shrink: 0;">
                <img src="{{ asset('images/abdominalesprincipiante.jpg') }}" alt="Abdominales Principiante" style="width: 100%; height: 100%; object-fit: cover;">
            </div>
            <div style="padding-left: 20px;">
                <h3 style="font-size: 20px; font-weight: 600; margin-bottom: 5px;">Abdominales Principiante</h3>
        ...
        <div style="display: flex; padding: 15px 0; border-bottom: 1px solid #eee;">
            ...
            <div style="padding-left: 20px;">
                <h3 style="font-size: 20px; font-weight: 600; margin-bottom: 5px;">Abdominales Intermedio</h3>
        ...
        <div style="display: flex; padding: 15px 0; border-bottom: 1px solid #eee;">
            ...
            <div style="padding-left: 20px;">
                <h3 style="font-size: 20px; font-weight: 600; margin-bottom: 5px;">Abdominales Avanzado</h3>
